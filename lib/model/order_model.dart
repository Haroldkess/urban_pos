...
class OrdersData {
  ...
  factory OrdersData.fromJson(Map<String, dynamic> json) => OrdersData(
        ...
        //   type: json["type"], //  null
        status:
            json["status"], //  [paid , refund , cancelled , incomplete payment]
        ...
        totalCostPrice:
            json["total_cost_price"], // total of all item costs price
  ...
  Cart copyWith({
    ...
    List<CartItem>? cartItems,
      ...
      Cart(
        ...
        userId: userId ?? this.userId,
        shopProductId: shopProductId ?? this.shopProductId,
        shopProductWholesaleId:
            shopProductWholesaleId ?? this.shopProductWholesaleId,
...
class CartItem {
  ...
  List<OrderProductWholesalePrice>? shopProductWholesalePrices;
  ...
  factory CartItem.fromJson(Map<String, dynamic> json) => CartItem(
        ...
        shopProduct: json["shop_product"] == null
            ? null
            : ShopProduct.fromJson(json["shop_product"]), //null
        shopProductWholesalePrices:
            json["shop_product_wholesale_prices"] == null
                ? []
                : List<OrderProductWholesalePrice>.from(
                    json["shop_product_wholesale_prices"]!
                        .map((x) => OrderProductWholesalePrice.fromJson(x))),
      );
...
class OrderProductWholesalePrice {
  int? id;
  int? shopProductId;
  int? userId;
  dynamic price;
  ...
  factory OrderProductWholesalePrice.fromJson(Map<String, dynamic> json) =>
      OrderProductWholesalePrice(
        id: json["id"],
